...
__all__ = ['_WALK_CONTROL_TIMESTEP', '_WALK_PHYSICS_TIMESTEP',
           '_TERMINAL_LINVEL', '_TERMINAL_ANGVEL', '_FLY_CONTROL_TIMESTEP',
           '_FLY_PHYSICS_TIMESTEP', '_TERMINAL_HEIGHT', '_BODY_PITCH_ANGLE',
           '_WING_PARAMS']
