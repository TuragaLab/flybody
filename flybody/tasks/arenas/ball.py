...
class BallFloor(composer.Arena):
    ...
    def _build(self, ball_pos=(0, 0, 0), ball_radius=1, ball_density=1.,
               name='ball', skybox=False, reflectance=0.2,
        ...
        if skybox:
            self._skybox_texture = self._mjcf_root.asset.add(
                ...
                rgb1=[.4, .6, .8], rgb2=[0., 0., 0.], markrgb=[1, 1, 1],
                mark='random', random=0.02, width=800, height=800,)
